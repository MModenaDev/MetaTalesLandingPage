...
const SectionBenefits: React.FC<SectionBenefitsProps> = () => {
	return (
		<section className="w-full px-8 md:px-20 lg:px-40 xl:px-60 py-16 text-center mb-4">
			<h3 className="text-3xl pb-8"><strong>Benefits</strong></h3>
			<div className="flex flex-wrap lg:flex-nowrap justify-between gap-8">
				<div className="flex flex-col items-center">
					...
					<h5 className="text-xl">Be rewarded<br /><span className="text-lg">for contributing</span></h5>
					<p className="mt-2">
				...
				<div className="flex flex-col items-center">
					...
					<h5 className="text-xl">Be listened<br /><span className="text-lg">about the characters you love</span></h5>
					<p className="mt-2">
				...
				<div className="flex flex-col items-center">
					...
					<h5 className="text-xl">Be part<br /><span className="text-lg">of new universes</span></h5>
					<p className="mt-2">
