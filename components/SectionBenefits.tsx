		...
		<section className="w-full px-8 md:px-20 lg:px-40 xl:px-60 py-16 text-center mb-4">
			...
			<div className="grid sm:grid-cols-3 gap-8">
				<div className="flex flex-col items-center">
					...
					<h5 className="text-2xl mt-8"><strong>Be rewarded<br /><span className="text-lg">for contributing</span></strong></h5>
					<p className="mt-2">
				...
				<div className="flex flex-col items-center">
					...
					<h5 className="text-2xl mt-8"><strong>Be listened<br /><span className="text-lg">about the characters you love</span></strong></h5>
					<p className="mt-2">
				...
				<div className="flex flex-col items-center">
					...
					<h5 className="text-2xl mt-8"><strong>Be part<br /><span className="text-lg">of new universes</span></strong></h5>
					<p className="mt-2">
