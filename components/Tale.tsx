...
const Tale: React.FC<TaleProps> = ({ universe, collection, type, name, description }) => {
	return (
		<div className="flex flex-col gap-4 border border-tertiary border-solid rounded-2xl mr-8 p-4 max-w-md bg-primary">
