...
const Footer: React.FC<FooterProps> = () => {
	return (
		<footer className="border-t border-MTred px-8 md:px-20 lg:px-40 xl:px-60 pt-8 pb-16">
			<div className="flex flex-wrap gap-4 justify-between pb-4 border-b border-MTred">
